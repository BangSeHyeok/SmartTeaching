 ...
 <head>
   ...
   <body id="page-top">
      <nav class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
         ...
         <a class="navbar-brand mr-1" href="views/index"><img class="img-fluid" alt="" src="resources/img/logo.png"></a>
         <!-- Navbar Search -->
         ...
         <ul class="navbar-nav ml-auto ml-md-0 osahan-right-navbar">
            <li class="nav-item mx-1">
               <a class="nav-link" href="views/upload">
            ...
            <li class="nav-item dropdown no-arrow osahan-right-navbar-user">
               ...
               <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="views/account"><i class="fas fa-fw fa-user-circle"></i> &nbsp; My Account</a>
                  <a class="dropdown-item" href="views/subscriptions"><i class="fas fa-fw fa-video"></i> &nbsp; Subscriptions</a>
                  <a class="dropdown-item" href="views/settings"><i class="fas fa-fw fa-cog"></i> &nbsp; Settings</a>
                  <div class="dropdown-divider"></div>
      ...
      <div id="wrapper">
         ...
         <ul class="sidebar navbar-nav">
            <li class="nav-item active">
               <a class="nav-link" href="views/index">
               <i class="fas fa-fw fa-home"></i>
               <span>Home</span>
               </a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="views/channels">
               <i class="fas fa-fw fa-users"></i>
               <span>Channels</span>
               </a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="views/single-channel">
               <i class="fas fa-fw fa-user-alt"></i>
               <span>Single Channel</span>
               </a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="views/video-page">
               <i class="fas fa-fw fa-video"></i>
               <span>Video Page</span>
               </a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="views/upload-video">
            ...
            <li class="nav-item dropdown">
               ...
               <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="views/login">Login</a>
                  <a class="dropdown-item" href="views/register">Register</a>
                  <a class="dropdown-item" href="views/forgot-password">Forgot Password</a>
                  <div class="dropdown-divider"></div>
                  <h6 class="dropdown-header">Other Pages:</h6>
                  <a class="dropdown-item" href="views/blog">Blog</a>
                  <a class="dropdown-item" href="views/blog-detail">Blog Detail</a>
                  <a class="dropdown-item" href="views/blank">Blank Page</a>
                  <a class="dropdown-item" href="views/404">404 Page</a>
                  <a class="dropdown-item" href="views/contact">Contact</a>
               </div>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="views/history-page">
               <i class="fas fa-fw fa-history"></i>
               <span>History Page</span>
               </a>
            </li>
            <li class="nav-item dropdown">
               <a class="nav-link dropdown-toggle" href="views/categories" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               <i class="fas fa-fw fa-list-alt"></i>
               <span>Categories</span>
               </a>
               <div class="dropdown-menu">
                  <a class="dropdown-item" href="views/categories">Movie</a>
                  <a class="dropdown-item" href="views/categories">Music</a>
                  <a class="dropdown-item" href="views/categories">Television</a>
               </div>
            </li>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 col-md-3">
                  <div class="footer-logo mb-4"><a class="logo" href="views/index"><img alt="" src="resources/img/logo.png" class="img-fluid"></a></div>
